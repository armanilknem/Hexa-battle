...
object MapData {
    ...
    val WATER_TILES = setOf(
        Pair(-4, 14), Pair(-3, 14), Pair(-2, 14),
        Pair(2, 9), Pair(3, 9), Pair(2, 8), Pair(3, 8), Pair(2, 7), Pair(3, 7), Pair(4, 7),
        Pair(9, 14), Pair(10, 14), Pair(9, 13), Pair(10, 13), Pair(9, 12), Pair(10, 12),
        Pair(10, 5), Pair(10, 4), Pair(11, 4),
        Pair(6, 1), Pair(7, 1), Pair(8, 1), Pair(9, 1), Pair(10, 1),
