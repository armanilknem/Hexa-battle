...
class EntityFactory(private val engine: Engine) {
     ...
     */
    fun createTroop(team: Team, unitType: UnitType, strength: Int, q: Int, r: Int) = engine.entity {
        val unitDef = UnitCatalog.units.getValue(unitType)
        with<UnitComponent> {
    ...
    fun createCity(name: String, baseProduction: Int, q: Int, r: Int, team: Team) = engine.entity {
        with<CityComponent> {
            this.name = name
    ...
    fun createCapital(name: String, baseProduction: Int, q: Int, r: Int, team: Team) = engine.entity {
        with<CityComponent> {
            this.name = name
            this.baseProduction = baseProduction
        }
    ...
    fun createTroopFromCity(cityEntity: Entity, unitType: UnitType): Entity {
        ...
        return createTroop(team.team, unitType, city.baseProduction, position.q, position.r)
    }
    ...
    fun createGameState(activeTeams: List<Team>) = engine.entity {
